...
void higeosse_derivs(int *neq, double *t, double *y, double *ydot, double *yout, int *ip){
    ...
    d0A_1A  = params_higeosse[5],
    d0A_01A = params_higeosse[6],
    d1A_0A = params_higeosse[7],
    d1A_01A = params_higeosse[8],
    d01A_0A = params_higeosse[9],
    d01A_1A = params_higeosse[10],
    
    d0A_0B = params_higeosse[11],
    d0A_0C = params_higeosse[12],
    d0A_0D = params_higeosse[13],
    d0A_0E = params_higeosse[14],
    d1A_1B = params_higeosse[15],
    d1A_1C = params_higeosse[16],
    d1A_1D = params_higeosse[17],
    d1A_1E = params_higeosse[18],
    d01A_01B = params_higeosse[19],
    d01A_01C = params_higeosse[20],
    d01A_01D = params_higeosse[21],
    d01A_01E = params_higeosse[22],
    
    s0B = params_higeosse[23],
    s1B = params_higeosse[24],
    s01B = params_higeosse[25],
    x0B = params_higeosse[26],
    x1B = params_higeosse[27],
    d0B_1B  = params_higeosse[28],
    ...
    d0B_0C = params_higeosse[35],
    d0B_0D = params_higeosse[36],
    d0B_0E = params_higeosse[37],
    d1B_1A = params_higeosse[38],
    d1B_1C = params_higeosse[39],
    d1B_1D = params_higeosse[40],
    d1B_1E = params_higeosse[41],
    d01B_01A = params_higeosse[42],
    d01B_01C = params_higeosse[43],
    d01B_01D = params_higeosse[44],
    d01B_01E = params_higeosse[45],
    
    s0C = params_higeosse[46],
    s1C = params_higeosse[47],
    s01C = params_higeosse[48],
    x0C = params_higeosse[49],
    x1C = params_higeosse[50],
    d0C_1C  = params_higeosse[51],
    d0C_01C = params_higeosse[52],
    d1C_0C = params_higeosse[53],
    d1C_01C = params_higeosse[54],
    d01C_0C = params_higeosse[55],
    d01C_1C = params_higeosse[56],

    d0C_0A = params_higeosse[57],
    d0C_0B = params_higeosse[58],
    d0C_0D = params_higeosse[59],
    d0C_0E = params_higeosse[60],
    d1C_1A = params_higeosse[61],
    d1C_1B = params_higeosse[62],
    d1C_1D = params_higeosse[63],
    d1C_1E = params_higeosse[64],
    d01C_01A = params_higeosse[65],
    d01C_01B = params_higeosse[66],
    d01C_01D = params_higeosse[67],
    d01C_01E = params_higeosse[68],
    
    s0D = params_higeosse[69],
    s1D = params_higeosse[70],
    s01D = params_higeosse[71],
    x0D = params_higeosse[72],
    x1D = params_higeosse[73],
    d0D_1D  = params_higeosse[74],
    d0D_01D = params_higeosse[75],
    d1D_0D = params_higeosse[76],
    d1D_01D = params_higeosse[77],
    d01D_0D = params_higeosse[78],
    d01D_1D = params_higeosse[79],

    d0D_0A = params_higeosse[80],
    d0D_0B = params_higeosse[81],
    d0D_0C = params_higeosse[82],
    d0D_0E = params_higeosse[83],
    d1D_1A = params_higeosse[84],
    d1D_1B = params_higeosse[85],
    d1D_1C = params_higeosse[86],
    d1D_1E = params_higeosse[87],
    d01D_01A = params_higeosse[88],
    d01D_01B = params_higeosse[89],
    d01D_01C = params_higeosse[90],
    d01D_01E = params_higeosse[91],
    
    s0E = params_higeosse[92],
    s1E = params_higeosse[93],
    s01E = params_higeosse[94],
    x0E = params_higeosse[95],
    x1E = params_higeosse[96],
    d0E_1E  = params_higeosse[97],
    d0E_01E = params_higeosse[98],
    d1E_0E = params_higeosse[99],
    d1E_01E = params_higeosse[100],
    d01E_0E = params_higeosse[101],
    d01E_1E = params_higeosse[102],

    d0E_0A = params_higeosse[103],
    d0E_0B = params_higeosse[104],
    d0E_0C = params_higeosse[105],
    d0E_0D = params_higeosse[106],
    d1E_1A = params_higeosse[107],
    d1E_1B = params_higeosse[108],
    d1E_1C = params_higeosse[109],
    d1E_1D = params_higeosse[110],
    d01E_01A = params_higeosse[111],
    d01E_01B = params_higeosse[112],
    d01E_01C = params_higeosse[113],
    d01E_01D = params_higeosse[114];
