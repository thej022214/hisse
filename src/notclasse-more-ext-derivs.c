...
static double params_mussem[NUMELEMENTS];


void initmod_mussem(void (* odeparms)(int *, double *)){
    int N = NUMELEMENTS;
    odeparms(&N, params_mussem);
}
...
void notclasse_more_derivs(int *neq, double *t, double *y, double *ydot, double *yout, int *ip){
    ...
    s0A = params_mussem[0],
    s1A = params_mussem[1],
    s01A = params_mussem[2],
    x0A = params_mussem[3],
    x1A = params_mussem[4],
    x01A = params_mussem[5],
    d0A_1A  = params_mussem[6],
    d0A_01A = params_mussem[7],
    d1A_0A = params_mussem[8],
    d1A_01A = params_mussem[9],
    d01A_0A = params_mussem[10],
    d01A_1A = params_mussem[11],
    
    d0A_0B = params_mussem[12],
    d0A_0C = params_mussem[13],
    d0A_0D = params_mussem[14],
    d0A_0E = params_mussem[15],
    d1A_1B = params_mussem[16],
    d1A_1C = params_mussem[17],
    d1A_1D = params_mussem[18],
    d1A_1E = params_mussem[19],
    d01A_01B = params_mussem[20],
    d01A_01C = params_mussem[21],
    d01A_01D = params_mussem[22],
    d01A_01E = params_mussem[23],
    
    s0B = params_mussem[24],
    s1B = params_mussem[25],
    s01B = params_mussem[26],
    x0B = params_mussem[27],
    x1B = params_mussem[28],
    x01B = params_mussem[29],
    d0B_1B  = params_mussem[30],
    d0B_01B = params_mussem[31],
    d1B_0B = params_mussem[32],
    d1B_01B = params_mussem[33],
    d01B_0B = params_mussem[34],
    d01B_1B = params_mussem[35],

    d0B_0A = params_mussem[36],
    d0B_0C = params_mussem[37],
    d0B_0D = params_mussem[38],
    d0B_0E = params_mussem[39],
    d1B_1A = params_mussem[40],
    d1B_1C = params_mussem[41],
    d1B_1D = params_mussem[42],
    d1B_1E = params_mussem[43],
    d01B_01A = params_mussem[44],
    d01B_01C = params_mussem[45],
    d01B_01D = params_mussem[46],
    d01B_01E = params_mussem[47],
    
    s0C = params_mussem[48],
    s1C = params_mussem[49],
    s01C = params_mussem[50],
    x0C = params_mussem[51],
    x1C = params_mussem[52],
    x01C = params_mussem[53],
    d0C_1C  = params_mussem[54],
    d0C_01C = params_mussem[55],
    d1C_0C = params_mussem[56],
    d1C_01C = params_mussem[57],
    d01C_0C = params_mussem[58],
    d01C_1C = params_mussem[59],

    d0C_0A = params_mussem[60],
    d0C_0B = params_mussem[61],
    d0C_0D = params_mussem[62],
    d0C_0E = params_mussem[63],
    d1C_1A = params_mussem[64],
    d1C_1B = params_mussem[65],
    d1C_1D = params_mussem[66],
    d1C_1E = params_mussem[67],
    d01C_01A = params_mussem[68],
    d01C_01B = params_mussem[69],
    d01C_01D = params_mussem[70],
    d01C_01E = params_mussem[71],
    
    s0D = params_mussem[72],
    s1D = params_mussem[73],
    s01D = params_mussem[74],
    x0D = params_mussem[75],
    x1D = params_mussem[76],
    x01D = params_mussem[77],
    d0D_1D  = params_mussem[78],
    d0D_01D = params_mussem[79],
    d1D_0D = params_mussem[80],
    d1D_01D = params_mussem[81],
    d01D_0D = params_mussem[82],
    d01D_1D = params_mussem[83],

    d0D_0A = params_mussem[84],
    d0D_0B = params_mussem[85],
    d0D_0C = params_mussem[86],
    d0D_0E = params_mussem[87],
    d1D_1A = params_mussem[88],
    d1D_1B = params_mussem[89],
    d1D_1C = params_mussem[90],
    d1D_1E = params_mussem[91],
    d01D_01A = params_mussem[92],
    d01D_01B = params_mussem[93],
    d01D_01C = params_mussem[94],
    d01D_01E = params_mussem[95],
    
    s0E = params_mussem[96],
    s1E = params_mussem[97],
    s01E = params_mussem[98],
    x0E = params_mussem[99],
    x1E = params_mussem[100],
    x01E = params_mussem[101],
    d0E_1E  = params_mussem[102],
    d0E_01E = params_mussem[103],
    d1E_0E = params_mussem[104],
    d1E_01E = params_mussem[105],
    d01E_0E = params_mussem[106],
    d01E_1E = params_mussem[107],

    d0E_0A = params_mussem[108],
    d0E_0B = params_mussem[109],
    d0E_0C = params_mussem[110],
    d0E_0D = params_mussem[111],
    d1E_1A = params_mussem[112],
    d1E_1B = params_mussem[113],
    d1E_1C = params_mussem[114],
    d1E_1D = params_mussem[115],
    d01E_01A = params_mussem[116],
    d01E_01B = params_mussem[117],
    d01E_01C = params_mussem[118],
    d01E_01D = params_mussem[119];
