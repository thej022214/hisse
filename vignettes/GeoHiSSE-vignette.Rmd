...
This tutorial gives some basic information on how to set up and execute parameter estimates for a series of models using GeoHiSSE (Caetano et al., in review). The GeoHiSSE models can be used to infer ancestral ranges, rates of dispersion and extirpation as well as testing hypothesis about range-dependent diversification processes.
...
For extinction fraction, 

$$\epsilon_{00i} = x_{00i} /  s_{00i}$$
$$\epsilon_{11i} = x_{11i} /  s_{11i}$$
$$\epsilon_{01i} = 0$$

It is straightforward to convert back to speciation and extinction:
