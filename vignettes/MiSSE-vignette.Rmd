...
I have already fit these models. Here is a simple plot to show that improvement in AIC as we increase the complexity of the model:
...
Let's take a look at the reconstruction for the `two.rate` model reconstruction. I will simply supply the reconstruction object if `misse.states` class to the plotting function, `plot.misse.states()`, and plot net diversification.
```{r, eval=FALSE}
...
And, as before, we simply supply this list to the plotting function, `plot.misse.states()`, and plot net diversification.
```{r, eval=FALSE}
