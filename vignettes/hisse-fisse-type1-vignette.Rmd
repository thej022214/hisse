...
#mtext(side=2, text="Proportion significant", line= 3.7, cex=1.2)
mtext("All non-SDD data sets",side=3, line=0, adj=0)
mtext(side=3, text="C", line=3.7, cex=1.4, las=1, at=.25)
```
...
plot(hist.obj, axes=FALSE, xlab="", ylab="", main="", xlim=c(0.6, 1.6), ylim=c(0,.3), col="blue")
par(tck=.01)
axis(2, at = seq(0,.3, by = .05), las =1, lwd=1, labels=TRUE, mgp=c(.75,.5,0))
axis(1, at = seq(0.6,1.6, by = .2), las =1, lwd=1, labels=TRUE, mgp=c(.75,.5,0))
abline(v=1, lty=2, lwd=2)
mtext("Tip ratio 0:1 turnover rate", side=1, line=3.25, cex=1.2)
mtext(side=2, text="Frequency", line= 3.7, cex=1.2)
mtext("Scenario 42: 54% 'False positive' rate",side=3, line=0, adj=0)
mtext(side=2, text="A", line=3.7, cex=1.4, las=1, at=1.05)
...
axis(1, at = seq(0.6,1.6, by = .2), las =1, lwd=1, labels=TRUE, mgp=c(.75,.5,0))
abline(v=1, lty=2, lwd=2)
mtext("Tip ratio 0:1 speciation rate", side=1, line=3.25, cex=1.2)
mtext(side=2, text="B", line= 3.7, cex=1.4, las=1, at=1.05)

hist.obj <- hist(final.res[,5], breaks=20, plot=FALSE)
hist.obj$counts <- hist.obj$counts/sum(hist.obj$counts)
plot(hist.obj, axes=FALSE, xlab="", ylab="", main="", xlim=c(0.6, 1.6), ylim=c(0,.3), col="blue")
par(tck=.01)
axis(2, at = seq(0,.3, by = .05), las =1, lwd=1, labels=TRUE, mgp=c(.75,.5,0))
axis(1, at = seq(0.6,1.6, by = .2), las =1, lwd=1, labels=TRUE, mgp=c(.75,.5,0))
abline(v=1, lty=2, lwd=2)
mtext("Tip ratio 0:1 extinction rate", side=1, line=3.25, cex=1.2)
